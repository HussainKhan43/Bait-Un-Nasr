        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="pt-5 mt-5 display-4 font-weight-bold">DHARAVI-BRANCH</h1>
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Abdullah Shah Patel</Card.Title>
            ...
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Miss. Rubana Shaikh</Card.Title>
      ...
      <section className="bank-info mt-5 py-5 bg-light">
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              <h3>Contact Us</h3>
              <p><strong>Address:</strong> "Shop No. 5, Nagree Apartments, Dharavi Main Road, Near Dharavi Jama Masjid, Mumbai – 400017."</p>
              <p>
                <strong>Phone Number:</strong> "24078395."
              </p>
            ...
            <Col md={12} className="mt-4">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.43420774892!2d72.8490475252046!3d19.044637582153513!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c8d627a0e01b%3A0x3b51024220143c11!2sSunni%20Jama%20Masjid%20Dharavi!5e0!3m2!1sen!2sin!4v1739197137028!5m2!1sen!2sin"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
