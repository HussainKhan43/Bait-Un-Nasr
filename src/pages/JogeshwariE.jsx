        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="pt-5 mt-5 display-4 font-weight-bold">JOGESHWARI(EAST)-BRANCH</h1>
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Sikander Sayed</Card.Title>
            ...
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Mudasir Shaikh</Card.Title>
      ...
      <section className="bank-info mt-5 py-5 bg-light">
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              <h3>Contact Us</h3>
              <p><strong>Address:</strong>"'Nasr Spot', Janta Quarters, Colaba Plot, House No.KEM-1008, Near Jhula Maidan, Jogeshwari East, Mumbai – 400060."</p>
              <p>
                <strong>Phone Number:</strong> "28378366."
              </p>
            ...
            <Col md={12} className="mt-4">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.406892103904!2d72.85541287497897!3d19.133658382082803!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b7d6a0dcc6e9%3A0xc96f82e3e3da2db5!2sJhula%20Maidan%20Rd%2C%20Saraswati%20Baug%2C%20Bandra%20Plot%2C%20Jogeshwari%20East%2C%20Mumbai%2C%20Maharashtra%20400060!5e0!3m2!1sen!2sin!4v1739198016428!5m2!1sen!2sin"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
