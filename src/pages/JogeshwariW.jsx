        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="pt-5 mt-5 display-4 font-weight-bold">JOGESHWARI(WEST)-BRANCH</h1>
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Awais Ansari</Card.Title>
            ...
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Samir Shaikh</Card.Title>
      ...
      <section className="bank-info mt-5 py-5 bg-light">
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              <h3>Contact Us</h3>
              <p><strong>Address:</strong>"Room No. G 2, Sayed Chawl SRA CHSL, S.V. Road, Near Laiba Hotel, Jogeshwari (West), Mumbai – 400102."</p>
              <p>
                <strong>Phone Number:</strong> "26782027."
              </p>
            ...
            <Col md={12} className="mt-4">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.3497265188794!2d72.84479337497895!3d19.136162782080884!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b7146bab3135%3A0xebb916c606fd0afd!2sTreebo%20Laaiba%20Residency!5e0!3m2!1sen!2sin!4v1739198546324!5m2!1sen!2sin" 
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
