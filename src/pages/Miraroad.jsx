        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="pt-5 mt-5 display-4 font-weight-bold">MIRAROAD-BRANCH</h1>
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Shakir Sayed</Card.Title>
            ...
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Mohammed Vakil</Card.Title>
      ...
      <section className="bank-info mt-5 py-5 bg-light">
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              <h3>Contact Us</h3>
              <p><strong>Address:</strong> "office No. 116', New Poonam Plaza,opp Narendra Park, Haideri Chowk Rd, Mira road(E) Thane – 401107."</p>
              <p>
                <strong>Phone Number:</strong> "8169664640"
              </p>
            ...
            <Col md={12} className="mt-4">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.9206990978855!2d72.85584797498295!3d19.285814481962436!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b1dba678d297%3A0xaba645e3377e1a3c!2sNew%20Poonam%20plaza!5e0!3m2!1sen!2sin!4v1739198726141!5m2!1sen!2sin"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
