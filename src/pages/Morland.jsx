        ...
        <Container>
          <Row>
            <Col className="text-center">
              <h1 className="pt-5 mt-5 display-4 font-weight-bold">MORLAND-BRANCH</h1>
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Miss. Taiba Shaikh</Card.Title>
            ...
            <Col xs={12} sm={6} md={4} className="mb-4">
              <Card className="director-card shadow-lg rounded">
                ...
                <Card.Body className="text-center">
                  <Card.Title className="font-weight-bold">Mr. Faraz Ahmed</Card.Title>
      ...
      <section className="bank-info mt-5 py-5 bg-light">
        <Container>
          ...
          <Row className="mt-4">
            <Col md={12}>
              <h3>Contact Us</h3>
              <p><strong>Address:</strong> "Qayyum Manzil, Shop No.7, Near Rehmani Mosque, Off Moreland Road, Madanpura, Mumbai – 400008."</p>
              <p>
                <strong>Phone Number:</strong> "23071727."
              </p>
            ...
            <Col md={12} className="mt-4">
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15092.89216935571!2d72.81776664340059!3d18.96575457728642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cf813baaa8cb%3A0x55c0d68681683f55!2zUmVobWFuaSBNYXNqaWQg2LHYrdmF2KfZhtuMINmF2LPYrNiv!5e0!3m2!1sen!2sin!4v1739197428630!5m2!1sen!2sin"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen=""
